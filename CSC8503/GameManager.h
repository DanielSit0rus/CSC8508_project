    ...
    namespace CSC8503 {
        ...
        public:
            ...
            PaintballGameObject* AddObject(GameObjectType type, const rp3d::Vector3& position, rp3d::Vector3 dimensions, rp3d::Quaternion orientation,
                Vector4 color = Vector4(1.0f, 1.0f, 1.0f, 1.0f), const string& meshName = "", float mass = 10.0f, bool isEnemy = false, rp3d::Vector3 oriV3 = rp3d::Vector3(),
                int network = -1);
            ...
            PaintballGameObject* AddConcaveMesh(const rp3d::Vector3& position, rp3d::Vector3 dimensions, rp3d::Quaternion orientation, const string& meshName, Vector4 color);
