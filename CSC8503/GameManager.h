...
namespace NCL {
    ...
    namespace CSC8503 {
        ...
        public:
            ...
            PaintballGameObject* AddBullet(rp3d::Vector3 ori3, bool isenemy, const rp3d::Vector3& position, rp3d::Vector3 dimensions, rp3d::Quaternion orientation, Vector4 color, float mass = 10.0f);
