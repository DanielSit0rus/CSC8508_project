...
UI::UI(PaintballGameWorld* world)
{
	...
	//EventManager::Subscribe(EventType::Mouse_Click_Test, [this](float& a, float& b) {ClickTest(a, b); });
	//EventManager::Subscribe(EventType::Mouse_Click_Test, [this](float& a, float& b) {ProcessClickEvent(a, b); });
